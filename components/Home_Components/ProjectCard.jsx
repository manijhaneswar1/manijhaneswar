    ...
    const projectsData = [
        {
            ...
            Link: "/rdc",
            image: "project_images/RDC_bg.jpg",
        },
        {
            id: "02",
            ...
            Link: "/mnrdc",
            image: "project_images/resbook_bg.jpg",
        },
        {
            id: "03",
            ...
            Link: "/car-pooling",
            image: "project_images/car_pooling_bg.jpg",
        },
    ];
    const handleScroll = ()=> {
        window.scrollBy({
            ...
            {projectsData.map((item, index) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div
                            className={`absolute inset-y-0 ${isEven ? "left-0" : "right-0"} w-full md:w-1/2 flex flex-col justify-center items-start px-10 md:px-20 lg:px-32 text-white`}
                        >
                            <h1 className="text-4xl md:text-6xl font-bold mb-4">{item.id}</h1>
                            <h2 className="text-3xl md:text-5xl font-semibold mb-4">{item.title}</h2>
